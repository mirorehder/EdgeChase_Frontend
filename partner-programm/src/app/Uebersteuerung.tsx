...
/**
 * Steuerelement, um die automatische Partner-Aufruf-Erkennung eines Reels von
 * Hand zu übersteuern - Vorbild: Uebersteuerung.tsx des Coupon-Automaten.
 */
    ...
    <div className="ig-uebersteuerung">
      ...
      {aktiv ? (
        ...
        <button className="ig-knopf ig-knopf-klein" onClick={() => setzen(true)} disabled={busy}>
          {busy ? "…" : "Als Partner-Aufruf markieren"}
        </button>
      )}
