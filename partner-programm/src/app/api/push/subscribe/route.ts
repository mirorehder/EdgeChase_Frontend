...
/**
 * Nimmt ein neues Web-Push-Abonnement des Browsers entgegen. Der Endpoint ist
 * unique - derselbe Browser mit demselben Abo verändert nichts (kein
 * Karteileichen bei Reloads).
 */
