 ...
 * keine eigene Anmeldung. Umgelegt wird nur ein Schalter - es werden weder
 * Daten preisgegeben noch Kosten ausgelöst, und der gefährlichere der beiden
 * Zustände ist "an", also der ohnehin voreingestellte.
 */
