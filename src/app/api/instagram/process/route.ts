...
/**
 * Bewusst strenger als die allgemeine Berechtigungsprüfung des Projekts.
 *
 * Diese Route legt Gutscheine an und verschickt Nachrichten. Die allgemeine
 * Prüfung lässt auch Aufrufe aus der eigenen Seite durch - das ist für ein
 * Dashboard richtig, hier wäre es zu weit gefasst. Deshalb nur der feste
 * Schlüssel, als Kopfzeile oder als "Bearer" für den Fall, dass die Route
 * einmal an einen Zeitplan gehängt wird.
 */
